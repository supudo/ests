class DashboardController < ApplicationController
  ...
  def index
    ...
    @users_per_technology = ActiveRecord::Base.connection.execute("SELECT t.title, COUNT(u.id) AS users_count FROM users AS u INNER JOIN technologies AS t ON t.id = u.technology_id GROUP BY u.technology_id")
