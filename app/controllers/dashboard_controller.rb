class DashboardController < ApplicationController
  ...
  def index
    ...
    @users_per_estimates = ActiveRecord::Base.connection.execute("SELECT CONCAT(u.first_name, ' ', u.last_name) AS 'user', count(e.id) FROM users AS u INNER JOIN estimates AS e ON e.owner_user_id = u.id GROUP BY u.id ORDER BY u.username")
