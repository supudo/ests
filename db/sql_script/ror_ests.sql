...
ALTER TABLE `estimates`
  ...
  ADD KEY `engagement_model_id` (`engagement_model_id`);
...
ALTER TABLE `estimates_lines`
  ...
  ADD KEY `estimates_sections_id` (`estimates_sections_id`),
...
ALTER TABLE `estimates_sections`
  ADD PRIMARY KEY (`id`),
  ADD KEY `estimate_id` (`estimate_id`),
  ADD KEY `estimates_sheet_id` (`estimates_sheet_id`);
...
ALTER TABLE `projects`
  ADD PRIMARY KEY (`id`),
  ADD KEY `client_id` (`client_id`),
  ADD KEY `account_manager_user_id` (`account_manager_user_id`),
  ADD KEY `production_manager_user_id` (`production_manager_user_id`),
  ADD KEY `project_owner_user_id` (`project_owner_user_id`),
